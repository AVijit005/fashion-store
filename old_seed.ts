...
const PHOTO_IDS = [
  "photo-1550614000-4b95d466f2fb",
  "photo-1523398002811-999aa8d9511e",
  ...
  "photo-1507680434267-3236ca9eece4",
  ...
  "photo-1520975954732-57dd22299614",
  "photo-1544441893-675973e31985",
  "photo-1485231183945-fffde7cecebe",
  "photo-1581655353564-df123a1eb820",
  "photo-1583743814966-8936f5b7be1a",
  "photo-1554568218-0f1715e72254",
  "photo-1611312449408-fcece27cdbb1",
  "photo-1578587018452-892bace03574",
...
for (let i = 0; i < 500; i++) {
  ...
  while (img2 === img1) {
    img2 = PHOTO_IDS[Math.floor(Math.random() * PHOTO_IDS.length)];
  }
